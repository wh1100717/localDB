define("localdb/0.0.1/src/localdb-debug", [], function(require, exports, module) {
  ...
  Engine = require("localdb/0.0.1/src/lib/engine-debug");
  dbPrefix = "ldb_";
  LocalDB = (function() {
    /*
     *  Constructor
...
define("localdb/0.0.1/src/lib/utils-debug", [], function(require, exports, module) {
  ...
  ObjectID = require("localdb/0.0.1/src/lib/bson-debug");
  Utils = {};
...
define("localdb/0.0.1/src/lib/bson-debug", [], function(require, exports, module) {
  ...
  BinaryParser = require("localdb/0.0.1/src/lib/binary-parser-debug");
  hexTable = (function() {
    var _i, _results;
    _results = [];
...
define("localdb/0.0.1/src/lib/binary-parser-debug", [], function(require, exports, module) {
  /**
   * Binary Parser.
    ...
    for (key in projection) {
      ...
      if (key.indexOf(".$") !== -1) {
        ...
        for (_i = 0, _len = item.length; _i < _len; _i++) {
          ...
          for (v_key in value) {
            v_value = value[v_key];
            if (Utils.isObject(v_value)) {} else {
              if (i[v_key] !== v_value) {
                flag = false;
              }
            }
...
define("localdb/0.0.1/src/lib/engine-debug", [], function(require, exports, module) {
  // Generated by CoffeeScript 1.7.1
  'use strict';
  var Engine;
  Engine = (function() {
